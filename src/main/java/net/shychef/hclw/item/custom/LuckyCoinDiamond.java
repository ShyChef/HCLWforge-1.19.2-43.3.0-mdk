...
public class LuckyCoinDiamond extends Item{

    public LuckyCoinDiamond(Properties p_41383_) {super(p_41383_);}
    @Override
    ...
    private void potioneffect(Player player ){
        if (getRandomnumber() >= 2){
            if (potionnumber() == 0) {
                player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 600, 1, true, true, true ));
            } if (potionnumber()== 1) {
                player.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 600, 1, true, true, true ));
                player.addEffect(new MobEffectInstance(MobEffects.NIGHT_VISION, 600, 1, true, true, true ));
            } if (potionnumber()==2) {
                player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 1, true, true, true ));
            } if (potionnumber()==3) {
                player.addEffect(new MobEffectInstance(MobEffects.HEAL, 1, 2, true, true, true ));
            }if (potionnumber()==4) {
                player.addEffect(new MobEffectInstance(MobEffects.JUMP, 600, 2, true, true, true ));
                player.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 600, 0, true, true, true ));
            }if (potionnumber()==5) {
                player.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 200, 1, true, true, true ));
            } if (potionnumber()==6) {
                player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 600, 1, true, true, true ));
                player.addEffect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 600, 1, true, true, true ));
            }if (potionnumber()==7) {
                player.addEffect(new MobEffectInstance(MobEffects.CONDUIT_POWER, 600, 1, true, true, true ));
                player.addEffect(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 600, 1, true, true, true ));
            }if (potionnumber()==8) {
                player.addEffect(new MobEffectInstance(MobEffects.HERO_OF_THE_VILLAGE, 600, 1, true, true, true ));
                player.addEffect(new MobEffectInstance(MobEffects.LUCK, 600, 0, true, true, true ));
            }if (potionnumber()==9) {
                player.addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, 500, 1, true, true, true ));
                player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 500, 1, true, true, true ));
            } if (potionnumber()==10) {
                player.addEffect(new MobEffectInstance(MobEffects.ABSORPTION, 600, 1, true, true, true ));
            }if (potionnumber()>=11) {
                player.addEffect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 200, 1, true, true, true ));
