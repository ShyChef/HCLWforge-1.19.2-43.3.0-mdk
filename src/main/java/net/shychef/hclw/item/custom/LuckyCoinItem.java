...
private void potioneffect(Player player ){
        if (getRandomnumber() >= 4){
            if (potionnumber() == 0) {
                ...
                player.addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, 400, 0, true, true, true ));
                player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400, 0, true, true, true ));
            } if (potionnumber()==10) {
                player.addEffect(new MobEffectInstance(MobEffects.ABSORPTION, 600, 0, true, true, true ));
            }if (potionnumber()>=11) {
                player.addEffect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 200, 0, true, true, true ));
